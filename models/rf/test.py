...
def test_rf_model(
    ...
    test_metrics = all_metrics(
        ...
        pred_proba=test_outputs["y_test_pred_proba"],
...
def test_rf_model_with_mlflow(
    ...
    tags = {"ModelType": "RandomForest", "ExperimentType": "Test"}
    ...
    # Evaluate Model
    results = test_rf_model(cfg=cfg, pipeline=pipeline, datamodule=datamodule)
