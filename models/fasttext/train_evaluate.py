...
from models.fasttext.test import test_fasttext_model_with_mlflow
...
def train_evaluate_notebook(cfg: DictConfig = None):
    ...
    with hydra.initialize(config_path="../conf", version_base=None):
        ...
        train_and_evaluate_fasttext_model_with_mlflow(cfg)
        return cfg


@hydra.main(
    config_path="../conf",
    config_name="fasttext_config",
    version_base=None,
)
...
def train_and_evaluate_fasttext_model_with_mlflow(
    ...
    Returns:
        dict with keys `model`, `datamodule`, `train_mlflow_run`, `train_tags`,
    ...
    with mlflow.start_run(
        ...
        with mlflow.start_run(
            ...
            results = train_fasttext_model_with_mlflow(
                cfg,
                log_model=False,
                create_run=False,
            )
        ...
        with mlflow.start_run(
            ...
            test_results = test_fasttext_model_with_mlflow(
