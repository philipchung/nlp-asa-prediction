...
def train_notebook(cfg: DictConfig = None):
    ...
    with hydra.initialize(config_path="../conf", version_base=None):
        ...
        train_svm_model_with_mlflow(cfg)
        return cfg


@hydra.main(config_path="../conf", config_name="svm_config", version_base=None)
def train_hydra(cfg: DictConfig):
    "Train Model on command line using default config."
    train_svm_model_with_mlflow(cfg)


def train_svm_model(cfg: Union[dict, DictConfig]) -> dict:
    ...
    # Create Model
    model = LinearSVC(**cfg.model.params)
    ...
    val_metrics = all_metrics(
        ...
        pred_score=outputs["y_val_pred_score"],
...
def train_svm_model_with_mlflow(
