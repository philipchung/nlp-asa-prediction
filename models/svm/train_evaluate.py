...
from models.svm.test import test_svm_model_with_mlflow
from models.svm.train import train_svm_model_with_mlflow
...
def train_evaluate_notebook(cfg: DictConfig = None):
    ...
    with hydra.initialize(config_path="../conf", version_base=None):
        cfg = hydra.compose(config_name="svm_config") if cfg is None else cfg
        train_and_evaluate_svm_model_with_mlflow(cfg)
        return cfg


@hydra.main(
    config_path="../conf",
    config_name="svm_config",
    version_base=None,
)
...
def train_and_evaluate_svm_model_with_mlflow(
    ...
    with mlflow.start_run(
        ...
        with mlflow.start_run(
            ...
            results = train_svm_model_with_mlflow(
        ...
        with mlflow.start_run(
            ...
            test_results = test_svm_model_with_mlflow(
