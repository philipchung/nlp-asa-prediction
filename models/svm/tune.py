...
from src.metrics.mlflow import itemize_tensors
...
def trial(config: dict) -> None:
    ...
    results = train_svm_model_with_mlflow(cfg)
...
@hydra.main(config_path="../conf", config_name="svm_tune_config", version_base=None)
def run_tune(cfg):
    ...
    tags = {"ModelType": "SupportVectorMachine", "ExperimentType": "Tune"}
    ...
    with mlflow.start_run(
        ...
        params = {"C": tune.loguniform(**cfg.model.tune.C)}
        ...
        # Run Tune
        best_trial_info = hyperparameter_tune_svm()
