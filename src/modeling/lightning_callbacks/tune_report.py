# Modification of ray.tune.integration.pytorch_lightning file
# for compatibility with Pytorch Lightning v1.8, which deprecates certain
# callback functions in TuneCallback
...
class TuneCallback(Callback):
    ...
    def on_fit_end(self, trainer: Trainer, pl_module: Optional[LightningModule]):
...
class TuneReportCallbackWithAdditionalMetrics(TuneReportCallback):
    """Same as TuneReportCallback, but additional metrics dict
    provided during __init__() will also be reported.
    """
    ...
    def _get_report_dict(self, trainer: Trainer, pl_module: LightningModule):
        ...
        report_dict = {**report_dict, **self._additional_metrics}
        return report_dict
